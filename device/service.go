...
// Service provides methods to interact with Device-related API endpoints.
...
// Get eSIM Device
func (api *Service) GetESimDevice(ctx context.Context, iccid string, params GetESimDeviceRequestParams, opts ...celitechconfig.RequestOption) ([]byte, error) {
	config := *api.config()
