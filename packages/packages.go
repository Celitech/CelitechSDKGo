...
type Packages struct {
	...
	DestinationIso2 string `json:"destinationISO2" required:"true"`
	// Size of the package in Bytes
	DataLimitInBytes float64 `json:"dataLimitInBytes" required:"true"`
	// Size of the package in GB
	DataLimitInGb float64 `json:"dataLimitInGB" required:"true"`
	// Min number of days for the package
	MinDays float64 `json:"minDays" required:"true"`
	// Max number of days for the package
	MaxDays float64 `json:"maxDays" required:"true"`
	// Price of the package in cents
	PriceInCents float64 `json:"priceInCents" required:"true"`
}
