...
// Service provides methods to interact with History-related API endpoints.
...
// Get eSIM History
func (api *Service) GetESimHistory(ctx context.Context, iccid string, params GetESimHistoryRequestParams, opts ...celitechconfig.RequestOption) ([]byte, error) {
	config := *api.config()
